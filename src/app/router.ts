...
import CausalKnowledgeBaseEditorView from '@/modules/causal-knowledge/views/CausalKnowledgeBaseEditorView.vue'
import ArgumentationFrameworkEditorView from '@/modules/argumentation/views/ArgumentationFrameworkEditorView.vue'
import ThirdPartyLicensesView from '@/modules/third-party-licenses/views/ThirdPartyLicensesView.vue'

...
import dix from '@/../third_party/xai-ca/xray/7a83aa5/examples/dix.json'
import double_loop from '@/../third_party/xai-ca//xray/7a83aa5/examples/double_loop.json'
import martin_str from '@/../third_party/xai-ca/xray/7a83aa5/examples/martin_str.json'
import matti_lpnmr_2024 from '@/../third_party/xai-ca/xray/7a83aa5/examples/matti_lpnmr_2024.json'
import meal_wine from '@/../third_party/xai-ca/xray/7a83aa5/examples/meal_wine.json'
import min_uniq_stb from '@/../third_party/xai-ca/xray/7a83aa5/examples/min_uniq_stb.json'
import pierson_post from '@/../third_party/xai-ca/xray/7a83aa5/examples/pierson_post.json'
import safa24 from '@/../third_party/xai-ca/xray/7a83aa5/examples/safa24.json'
import simple_game from '@/../third_party/xai-ca/xray/7a83aa5/examples/simple_game.json'
import tapp24 from '@/../third_party/xai-ca/xray/7a83aa5/examples/tapp24.json'
import tapp25 from '@/../third_party/xai-ca/xray/7a83aa5/examples/tapp25.json'
import unique_stb from '@/../third_party/xai-ca/xray/7a83aa5/examples/unique-stb.json'
import wild_animals from '@/../third_party/xai-ca/xray/7a83aa5/examples/wild-animals.json'

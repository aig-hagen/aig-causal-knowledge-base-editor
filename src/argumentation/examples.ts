...
import dix from '@/../third_party/xray/examples/dix.json'
import double_loop from '@/../third_party/xray/examples/double_loop.json'
import martin_str from '@/../third_party/xray/examples/martin_str.json'
import matti_lpnmr_2024 from '@/../third_party/xray/examples/matti_lpnmr_2024.json'
import meal_wine from '@/../third_party/xray/examples/meal_wine.json'
import min_uniq_stb from '@/../third_party/xray/examples/min_uniq_stb.json'
import pierson_post from '@/../third_party/xray/examples/pierson_post.json'
import safa24 from '@/../third_party/xray/examples/safa24.json'
import simple_game from '@/../third_party/xray/examples/simple_game.json'
import tapp24 from '@/../third_party/xray/examples/tapp24.json'
import tapp25 from '@/../third_party/xray/examples/tapp25.json'
import unique_stb from '@/../third_party/xray/examples/unique-stb.json'
import wild_animals from '@/../third_party/xray/examples/wild-animals.json'
